...
public class AbsorberC implements Absorber {
	...
	public AbsorberC(String name, int x, int y, int width, int height) {
		this.x = x;
		this.y = -y;
		this.height = height;
		this.width = width;
	...
	/**
	 * Determines if a ball is currently inside an absorber. 
	 * TODO Use this to track when ball leaves so you can fire another ball. 
	 * @param ball
	 * @return
	 */
